...
filt_path <- "/SAN/Susanas_den/EimeriaMicrobiome/R/results/filtered_TestRun_1/"
#Pipeline filtration 
...
pdf("/SAN/Susanas_den/EimeriaMicrobiome/R/results/qualityProfileF1_testrun1.pdf",
    height = 7, width = 7)
plotQualityProfile(fastqF[[1]])
dev.off()

#Quality plots of the reads
pdf("/SAN/Susanas_den/EimeriaMicrobiome/R/results/qualityProfileR20_testrun1.pdf",
    height = 7, width = 7)
...
if(doMultiAmp){
  ...
  filedir <- "/SAN/Susanas_den/EimeriaMicrobiome/R/results/stratified_filea_test_run_1"
  ...
  saveRDS(MA, "/SAN/Susanas_den/EimeriaMicrobiome/R/MA_multi_testrun_1.RDS")
} else{
  #MA <- readRDS("/SAN/Victors_playground/Eimeria_microbiome/MA_Multi_TestRun.RDS")
  MA <- readRDS("/SAN/Susanas_den/EimeriaMicrobiome/R/MA_multi_testrun_1.RDS")
}
...
MA <- blastTaxAnnot(MA,
                    ...
                    infasta = "/SAN/Susanas_den/EimeriaMicrobiome/tmp/in_testrun1",
                    #outblast = "/SAN/Victors_playground/Eimeria_microbiome/Multimarker/out_TestRun.fasta",
                    outblast = "/SAN/Susanas_den/EimeriaMicrobiome/R/results/out_TestRun_1.fasta",
...
saveRDS(MA, file="/SAN/Susanas_den/EimeriaMicrobiome/R/results/MATax_TestRun_1.Rds")
} else {
    MA1 <- readRDS("/SAN/Susanas_den/EimeriaMicrobiome/R/results/MATax_FullRun_1.Rds")
    MA2 <- readRDS("/SAN/Susanas_den/EimeriaMicrobiome/R/results/MATax_TestRun_1.Rds")  
}
...
####Merge phyloseq objects   
    PS2 <-  readRDS(file="/SAN/Susanas_den/EimeriaMicrobiome/R/results/PhyloSeqData_TestRun.Rds")
    PS1<-  readRDS(file="/SAN/Susanas_den/EimeriaMicrobiome/R/results/PhyloSeqData_FullRun_1.Rds")
    PS <- merge_phyloseq(PS1, PS2) ###Works! 
    saveRDS(PS, file="/SAN/Susanas_den/EimeriaMicrobiome/R/results/PhyloSeqData_All.Rds") ###Results from full + test run 
}
